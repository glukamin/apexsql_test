...
CREATE PROCEDURE [dbo].[ICE_sp_ActivationList_TEST]
AS
BEGIN
SELECT         
T.Product_ID,         
...
FROM ( 
	...
	LEN(ISNULL(ICE_Products.Bundle_Products, '')) = 0  
	UNION 
...
GO
GRANT EXECUTE
	ON [dbo].[ICE_sp_ActivationList_TEST]
	TO [adrijan.bandu]
GO
GRANT EXECUTE
	ON [dbo].[ICE_sp_ActivationList_TEST]
