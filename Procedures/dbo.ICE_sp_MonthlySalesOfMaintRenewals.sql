...
CREATE procedure [dbo].[ICE_sp_MonthlySalesOfMaintRenewals]
(
	@DateBegin datetime, 
	@DateEnd datetime
)
...
(
	...
	where 
		...
		ICE_Orders.Order_Date <= @DateEnd and ICE_Extension_Details.Maintenance_ID IN (1,2,3) 
...
GO
GRANT EXECUTE
	ON [dbo].[ICE_sp_MonthlySalesOfMaintRenewals]
	TO [adrijan.bandu]
GO
GRANT EXECUTE
	ON [dbo].[ICE_sp_MonthlySalesOfMaintRenewals]
