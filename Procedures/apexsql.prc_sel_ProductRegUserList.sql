...
CREATE   PROCEDURE prc_sel_ProductRegUserList 
/* ------------------------------------------------------------
   PROCEDURE:    prc_sel_ProductRegUserList 
   
   DESCRIPTION:  Search Results of UserLaist with Username, Email ,Company etc.,
   
   AUTHOR:       Brian Lockwood 12/27/2001 3:13:39 PM     
		 03/29/05 Modifed based on tblAuthor              
   ------------------------------------------------------------ */
	...
	--view str
	Select @SQLStr = 'Select distinct a.UserID,
		b.Username,
		b.Real_name,		
		b.Author_email,
		b.Homepage
	...
	*/
	...
	Select @SQLStr= @SQLStr + @SearchStr + '  order by b.Username'
...
GO
GRANT EXECUTE
	ON [apexsql].[prc_sel_ProductRegUserList]
	TO [adrijan.bandu]
GO
GRANT EXECUTE
	ON [apexsql].[prc_sel_ProductRegUserList]
